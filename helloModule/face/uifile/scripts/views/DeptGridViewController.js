...
//uifile、DeptGridView在编译时将自动替换为实际值，设计过程中不要随意修改

uifile.views.DeptGridViewController = function(){
	var me = $extend(mx.views.ViewController);
	me.typeName="uifile.views.DeptGridViewController";
	me.getController=function(key){
		return me.getLinkViewController("uifile.views."+key+"Controller");
	};
	me.getView = function(){
		if (me.view == null){
			me.view = new uifile.views.DeptGridView({ controller: me });
		}
		return me.view;
	};
	...
	me._NewButton_onclick = function() {
		var detailController = me.getController("DeptFormView");
