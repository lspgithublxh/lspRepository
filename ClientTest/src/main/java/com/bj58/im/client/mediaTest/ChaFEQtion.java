...
//			System.out.println(plist.get(i).getX() + "," + plist.get(i).getY() / fanwei * rate);
			...
			path.getElements().add(new CubicCurveTo(centerX, plist.get(i).getY()/ fanwei* rate,
						centerX, plist.get(i+1).getY()/ fanwei* rate, plist.get(i+1).getX(), plist.get(i+1).getY()/ fanwei* rate));
		}
