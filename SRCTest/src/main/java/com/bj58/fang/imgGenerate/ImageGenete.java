...
public class ImageGenete {  
    ...
    public static void main(String[] args) {  
    	...
    	ImageGenete tt = new ImageGenete();  
  
        BufferedImage d = tt.loadImageLocal("D:\\a.png");  
//      BufferedImage b = tt  
//              .loadImageLocal("E:\\文件(word,excel,pdf,ppt.txt)\\zte-logo.png");  
        ...
        System.out.println(getBigerPic("https://pic1.ajkimg.com/display/anjuke/6f0d75927f652585d577138b60e14a15/241x320x155x35/100x133.jpg"));
    }  
  
    
    public static String getBigerPic(String image) {
		String start = image.substring(0, image.lastIndexOf("/") + 1);
		String end = image.substring(image.lastIndexOf("."));
		String rs = start + "200x233" + end;
		return rs;
