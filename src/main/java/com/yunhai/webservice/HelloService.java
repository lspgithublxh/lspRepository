 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://www.baidu.com", wsdlLocation = "http://localhost:8080/services?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://www.baidu.com", "HelloService");
     ...
     *     returns AppImp
     */
    @WebEndpoint(name = "AppImpPort")
    public AppImp getAppImpPort() {
        return super.getPort(new QName("http://www.baidu.com", "AppImpPort"), AppImp.class);
    }
     ...
     */
    @WebEndpoint(name = "AppImpPort")
    public AppImp getAppImpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.baidu.com", "AppImpPort"), AppImp.class, features);
    }
